...
A = int(input("Masukkan studytime (1=kurang, 2=sedang, 3=bagus, 4=sangat bagus): "))
B = int(input("Masukkan jumlah kegagalan (0-3): "))
C = int(input("Masukkan jumlah ketidakhadiran: "))
D = int(input("Masukkan nilai ujian pertama (0-20): "))
E = int(input("Masukkan nilai ujian kedua (0-20): "))

# bentuk data sesuai urutan X
Train = [A, B, C, D, E]
print("Data input:", Train)

# jadikan dataframe biar cocok ke model
test = pd.DataFrame([Train], columns=["studytime","failures","absences","G1","G2"])
